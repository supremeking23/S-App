        ...
        <div class="row">
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <?php  $get_profesor = get_professor_by_id($_GET['professor_id']); ?>
              <!-- for numbers and letters validation -->

              <script src = "../js/validations.js"></script>
              <div class="active tab-pane" id="settings">
                <form action="process_pages/edit_prof_process.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                <?php if($get_profesor): ?>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="first_name" name="first_name" placeholder="" onkeypress = "return lettersonly(event)" value="<?php echo $get_profesor['first_name'];?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="middle_name" name="middle_name" onkeypress = "return lettersonly(event)" placeholder="" value="<?php echo $get_profesor['middle_name'];?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="last_name" name="last_name" onkeypress = "return lettersonly(event)" value="<?php echo $get_profesor['last_name'];?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="email" name="email" value="<?php echo $get_profesor['email'];?>">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="address" name="address" placeholder="" value="<?php echo $get_profesor['address'];?>">
                    </div>
                  </div>
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="date" class="form-control" id="date_birth" name="date_birth"  value="<?php echo $get_profesor['date_birth'];?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-sm-10">
                      <select class="form-control" name="gender">
                        <option value="Male" <?php if($get_profesor['gender'] == 'Male') echo "selected=''"; ?>>Male</option>
                        <option value="Female" <?php if($get_profesor['gender'] == 'Female') echo "selected=''"; ?>>Female</option>
                      </select>
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="contact" name="contact" placeholder="" value="<?php echo $get_profesor['contact'];?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      <input type="file" name="upload_image" onchange="document.getElementById('image').src = window.URL.createObjectURL(this.files[0])" >
                       <input type="hidden" value="<?php echo $get_profesor['image']?>" name="image_name">
                      
                      <img id="image" class="profile-user-img img-responsive " src="../professor_images/<?php echo $professor_image;?>" alt="User profile picture">
                    </div>
                  </div>

                   <!-- for prof_id -->
                    <input type="hidden" name="prof_id" value="<?php echo $get_profesor['tbl_prof_id']?>">
