                 ...
                 <?php //display all admins
                  ...
                  <tr>
                   ...
                   <td><?php echo $department_code['department_code']?></td>
                    ...
                    ?>
                   <td><a  data-toggle='modal' data-tooltip="tooltip" data-placement="left" data-title="Delete Information" data-target='#deletemodal<?php echo $total_admin['admin_id']?>' ><span class='glyphicon glyphicon-trash'></span></a> | <a  href="admin_full_info.php?admin_id=<?php echo $total_admin['admin_id']; ?>" ><span class='glyphicon glyphicon-user'></span></a></td>
                </tr>

                  <!-- for delete modal admin -->
                
                        <div class="modal modal-danger fade" id="deletemodal<?php echo $total_admin['admin_id']?>">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p>Please Enter Your Password to continue</p>
                               <form action="process_pages/delete_admin_process.php" method="POST">

                                 <input type="hidden" name="admin_id" value="<?php echo $admin_id ?>">  
                                 <input type="hidden" name="delete_admin" value="<?php echo $total_admin['admin_id'];?>">
                            ...
                            <div class="modal-footer">
                              <button type="submit" name="admin_delete" class="btn btn-outline">Save changes</button>
                              </form>
                            </div>
                          </div>
                          <!-- /.modal-content -->
